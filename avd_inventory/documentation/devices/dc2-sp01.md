...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 111.2.1.1/8 | 172.16.1.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-LF01_Ethernet1 | routed | - | 10.255.255.104/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-LF02_Ethernet1 | routed | - | 10.255.255.108/31 | default | 9214 | False | - | - |
| Ethernet3 | P2P_LINK_TO_DC2-LF03_Ethernet1 | routed | - | 10.255.255.112/31 | default | 9214 | False | - | - |
| Ethernet4 | P2P_LINK_TO_DC2-LF04_Ethernet1 | routed | - | 10.255.255.116/31 | default | 9214 | False | - | - |
| Ethernet5 | P2P_LINK_TO_DC2-LF05_Ethernet1 | routed | - | 10.255.255.120/31 | default | 9214 | False | - | - |
| Ethernet6 | P2P_LINK_TO_DC2-LF06_Ethernet1 | routed | - | 10.255.255.124/31 | default | 9214 | False | - | - |
...
| 10.255.128.17 | 65205 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
| 10.255.128.18 | 65206 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - | - | - | - |
...
| 10.255.255.121 | 65205 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.255.125 | 65206 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
router bgp 65200
   ...
   neighbor 10.255.255.105 description dc2-lf01_Ethernet1
   neighbor 10.255.255.109 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.109 remote-as 65202
   neighbor 10.255.255.109 description dc2-lf02_Ethernet1
   neighbor 10.255.255.113 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.113 remote-as 65203
   neighbor 10.255.255.113 description dc2-lf03_Ethernet1
   neighbor 10.255.255.117 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.117 remote-as 65204
   neighbor 10.255.255.117 description dc2-lf04_Ethernet1
   neighbor 10.255.255.121 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.121 remote-as 65205
   neighbor 10.255.255.121 description dc2-lf05_Ethernet1
   neighbor 10.255.255.125 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.125 remote-as 65206
   neighbor 10.255.255.125 description dc2-lf06_Ethernet1
