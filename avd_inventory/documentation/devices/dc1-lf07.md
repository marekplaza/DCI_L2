...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 111.1.2.7/8 | 172.16.1.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP01_Ethernet7 | routed | - | 10.255.255.25/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP02_Ethernet7 | routed | - | 10.255.255.27/31 | default | 9214 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.255.0.9/32 |
...
| 10.255.255.24 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
| 10.255.255.26 | 65100 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.255.0.9:10010 | 10010:10010 | - | - | learned |
| 20 | 10.255.0.9:10020 | 10020:10020 | - | - | learned |
...
router bgp 65107
   ...
   neighbor 10.255.255.24 remote-as 65100
   neighbor 10.255.255.24 description dc1-sp01_Ethernet7
   neighbor 10.255.255.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.26 remote-as 65100
   neighbor 10.255.255.26 description dc1-sp02_Ethernet7
