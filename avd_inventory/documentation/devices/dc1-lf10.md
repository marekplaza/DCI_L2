...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 111.1.2.10/8 | 172.16.1.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP01_Ethernet10 | routed | - | 10.255.255.37/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP02_Ethernet10 | routed | - | 10.255.255.39/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC1-SP01_Ethernet10
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SP02_Ethernet10
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.255.0.12/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.1.12/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.255.0.12:10010 | 10010:10010 | - | - | learned |
| 20 | 10.255.0.12:10020 | 10020:10020 | - | - | learned |
...
router bgp 65110
   ...
   neighbor 10.255.255.36 description dc1-sp01_Ethernet10
   neighbor 10.255.255.38 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.38 remote-as 65100
   neighbor 10.255.255.38 description dc1-sp02_Ethernet10
