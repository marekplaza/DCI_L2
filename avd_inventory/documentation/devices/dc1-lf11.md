...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 111.1.2.11/8 | 172.16.1.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP01_Ethernet11 | routed | - | 10.255.255.41/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP02_Ethernet11 | routed | - | 10.255.255.43/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC1-SP01_Ethernet11
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SP02_Ethernet11
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.255.0.13/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.1.13/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.255.0.13:10010 | 10010:10010 | - | - | learned |
| 20 | 10.255.0.13:10020 | 10020:10020 | - | - | learned |
...
router bgp 65111
   ...
   neighbor 10.255.255.40 description dc1-sp01_Ethernet11
   neighbor 10.255.255.42 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.42 remote-as 65100
   neighbor 10.255.255.42 description dc1-sp02_Ethernet11
