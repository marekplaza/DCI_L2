...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 111.2.2.3/8 | 172.16.1.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SP01_Ethernet3 | routed | - | 10.255.255.113/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SP02_Ethernet3 | routed | - | 10.255.255.115/31 | default | 9214 | False | - | - |
| Ethernet6 | P2P_LINK_TO_dc1-lf03_Ethernet6 | routed | - | 172.16.100.1/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC2-SP01_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_DC2-SP02_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_dc1-lf03_Ethernet6
   no shutdown
   mtu 9214
   no switchport
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.129.79/32 |
...
| 10.255.128.15 | 65203 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - | - |
...
| 20 | 10.255.128.15:10020 | 10020:10020<br>remote 10020:10020 | - | - | learned |
...
router bgp 65203
   ...
   neighbor 10.255.255.112 description dc2-sp01_Ethernet3
   neighbor 10.255.255.114 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.114 remote-as 65200
   neighbor 10.255.255.114 description dc2-sp02_Ethernet3
   neighbor 172.16.100.0 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.100.0 remote-as 65102
   neighbor 172.16.100.0 local-as 65202 no-prepend replace-as
   neighbor 172.16.100.0 description dc1-lf03
   ...
   !
   vlan 20
      rd 10.255.128.15:10020
      rd evpn domain remote 10.255.128.15:10020
...
| 20 | permit 10.255.129.64/27 eq 32 |
