...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 111.1.2.5/8 | 172.16.1.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP01_Ethernet5 | routed | - | 10.255.255.17/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP02_Ethernet5 | routed | - | 10.255.255.19/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC1-SP01_Ethernet5
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SP02_Ethernet5
   no shutdown
   mtu 9214
   no switchport
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.255.0.7:10010 | 10010:10010 | - | - | learned |
| 20 | 10.255.0.7:10020 | 10020:10020 | - | - | learned |
...
router bgp 65105
   ...
   neighbor 10.255.255.16 description dc1-sp01_Ethernet5
   neighbor 10.255.255.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.18 remote-as 65100
   neighbor 10.255.255.18 description dc1-sp02_Ethernet5
