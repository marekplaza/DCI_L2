...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 111.1.2.3/8 | 172.16.1.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP01_Ethernet3 | routed | - | 10.255.255.9/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP02_Ethernet3 | routed | - | 10.255.255.11/31 | default | 9214 | False | - | - |
| Ethernet6 | P2P_LINK_TO_dc2-lf03_Ethernet6 | routed | - | 172.16.100.0/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC1-SP01_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SP02_Ethernet3
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_dc2-lf03_Ethernet6
   no shutdown
   mtu 9214
   no switchport
...
| 20 | 10.255.0.5:10020 | 10020:10020<br>remote 10020:10020 | - | - | learned |
...
router bgp 65103
   ...
   neighbor 10.255.255.8 description dc1-sp01_Ethernet3
   neighbor 10.255.255.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.10 remote-as 65100
   neighbor 10.255.255.10 description dc1-sp02_Ethernet3
   neighbor 172.16.100.1 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.100.1 remote-as 65202
   neighbor 172.16.100.1 local-as 65102 no-prepend replace-as
   neighbor 172.16.100.1 description dc2-lf03
   ...
   vlan 20
      rd 10.255.0.5:10020
      rd evpn domain remote 10.255.0.5:10020
