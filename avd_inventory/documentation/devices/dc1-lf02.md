...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 111.1.2.2/8 | 172.16.1.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet10 | dc1-h01 | *trunk | *10 | *- | *- | 10 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP01_Ethernet2 | routed | - | 10.255.255.5/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP02_Ethernet2 | routed | - | 10.255.255.7/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC1-SP01_Ethernet2
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SP02_Ethernet2
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel10 | dc1-h01 | switched | trunk | 10 | - | - | - | - | - | 0000:0000:dc01:dc01:0010 |
...
| --------- | --------------------------- | --------------------------- | ------------ |
| Port-Channel10 | 0000:0000:dc01:dc01:0010 | all-active | dc:01:dc:01:00:10 |
...
interface Port-Channel10
   ...
   evpn ethernet-segment
      identifier 0000:0000:dc01:dc01:0010
      route-target import dc:01:dc:01:00:10
   lacp system-id dc01.dc01.0010
```
...
router bgp 65102
   ...
   neighbor 10.255.255.4 description dc1-sp01_Ethernet2
   neighbor 10.255.255.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.6 remote-as 65100
   neighbor 10.255.255.6 description dc1-sp02_Ethernet2
