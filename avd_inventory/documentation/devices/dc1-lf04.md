...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 111.1.2.4/8 | 172.16.1.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP01_Ethernet4 | routed | - | 10.255.255.13/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP02_Ethernet4 | routed | - | 10.255.255.15/31 | default | 9214 | False | - | - |
| Ethernet6 | P2P_LINK_TO_dc2-lf04_Ethernet6 | routed | - | 172.16.100.2/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC1-SP01_Ethernet4
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SP02_Ethernet4
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_dc2-lf04_Ethernet6
   no shutdown
   mtu 9214
   no switchport
...
| 10.255.128.16 | 65204 | default | - | Inherited from peer group EVPN-OVERLAY-CORE | Inherited from peer group EVPN-OVERLAY-CORE | - | Inherited from peer group EVPN-OVERLAY-CORE | - | - | - | - |
...
| 20 | 10.255.0.6:10020 | 10020:10020<br>remote 10020:10020 | - | - | learned |
...
router bgp 65104
   ...
   neighbor 10.255.255.12 description dc1-sp01_Ethernet4
   neighbor 10.255.255.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.14 remote-as 65100
   neighbor 10.255.255.14 description dc1-sp02_Ethernet4
   neighbor 172.16.100.3 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.16.100.3 remote-as 65202
   neighbor 172.16.100.3 local-as 65102 no-prepend replace-as
   neighbor 172.16.100.3 description dc2-lf04
   ...
   vlan 20
      rd 10.255.0.6:10020
      rd evpn domain remote 10.255.0.6:10020
