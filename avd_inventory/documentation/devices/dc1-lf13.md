...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 111.1.2.13/8 | 172.16.1.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP01_Ethernet13 | routed | - | 10.255.255.49/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP02_Ethernet13 | routed | - | 10.255.255.51/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC1-SP01_Ethernet13
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SP02_Ethernet13
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 10.255.0.15/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.1.15/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.255.0.15:10010 | 10010:10010 | - | - | learned |
| 20 | 10.255.0.15:10020 | 10020:10020 | - | - | learned |
...
router bgp 65113
   ...
   neighbor 10.255.255.48 description dc1-sp01_Ethernet13
   neighbor 10.255.255.50 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.50 remote-as 65100
   neighbor 10.255.255.50 description dc1-sp02_Ethernet13
   redistribute connected route-map RM-CONN-2-BGP
   !
   vlan 10
      rd 10.255.0.15:10010
      route-target both 10010:10010
      redistribute learned
   !
   vlan 20
      rd 10.255.0.15:10020
