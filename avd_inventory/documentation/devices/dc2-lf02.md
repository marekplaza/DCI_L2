...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 111.2.2.2/8 | 172.16.1.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SP01_Ethernet2 | routed | - | 10.255.255.109/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SP02_Ethernet2 | routed | - | 10.255.255.111/31 | default | 9214 | False | - | - |
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.129.78/32 |
...
| 20 | 10.255.128.14:10020 | 10020:10020 | - | - | learned |
...
router bgp 65202
   ...
   neighbor 10.255.255.108 description dc2-sp01_Ethernet2
   neighbor 10.255.255.110 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.110 remote-as 65200
   neighbor 10.255.255.110 description dc2-sp02_Ethernet2
