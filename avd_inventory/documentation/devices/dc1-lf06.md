...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 111.1.2.6/8 | 172.16.1.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC1-SP01_Ethernet6 | routed | - | 10.255.255.21/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC1-SP02_Ethernet6 | routed | - | 10.255.255.23/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC1-SP01_Ethernet6
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_DC1-SP02_Ethernet6
   no shutdown
   mtu 9214
   no switchport
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 10.255.0.8:10010 | 10010:10010 | - | - | learned |
| 20 | 10.255.0.8:10020 | 10020:10020 | - | - | learned |
...
router bgp 65106
   ...
   neighbor 10.255.255.20 description dc1-sp01_Ethernet6
   neighbor 10.255.255.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.22 remote-as 65100
   neighbor 10.255.255.22 description dc1-sp02_Ethernet6
