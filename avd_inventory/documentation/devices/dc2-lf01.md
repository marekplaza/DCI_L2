...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 111.2.2.1/8 | 172.16.1.1 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet10 | dc2-h01 | *trunk | *10 | *- | *- | 10 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_LINK_TO_DC2-SP01_Ethernet1 | routed | - | 10.255.255.105/31 | default | 9214 | False | - | - |
| Ethernet2 | P2P_LINK_TO_DC2-SP02_Ethernet1 | routed | - | 10.255.255.107/31 | default | 9214 | False | - | - |
...
!
interface Ethernet1
   description P2P_LINK_TO_DC2-SP01_Ethernet1
   no shutdown
   mtu 9214
   no switchport
...
!
interface Ethernet2
   description P2P_LINK_TO_DC2-SP02_Ethernet1
   no shutdown
   mtu 9214
   no switchport
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel10 | dc2-h01 | switched | trunk | 10 | - | - | - | - | - | 0000:0000:dc02:dc02:0010 |
...
| --------- | --------------------------- | --------------------------- | ------------ |
| Port-Channel10 | 0000:0000:dc02:dc02:0010 | all-active | dc:02:dc:02:00:10 |
...
interface Port-Channel10
   ...
   evpn ethernet-segment
      ...
      route-target import dc:02:dc:02:00:10
   lacp system-id dc02.dc02.0010
```
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 10.255.129.77/32 |
...
| 20 | 10.255.128.13:10020 | 10020:10020 | - | - | learned |
...
router bgp 65201
   ...
   neighbor 10.255.255.104 description dc2-sp01_Ethernet1
   neighbor 10.255.255.106 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.106 remote-as 65200
   neighbor 10.255.255.106 description dc2-sp02_Ethernet1
